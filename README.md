<p align="center">
   <img src="https://github.com/The-Syntax-Slayer/Octopal/blob/main/logo.png?raw=true" alt="Octapal"/>
</p>
...
<p align="center">
   <img src="https://img.shields.io/github/v/release/The-Syntax-Slayer/Octopal">
   <a href="LICENSE"><img src="https://img.shields.io/github/license/The-Syntax-Slayer/Octopal?svg=true"></a>
   <a href="https://deepwiki.com/The-Syntax-Slayer/Octopal"><img src="https://deepwiki.com/badge.svg"></a>
</p>
...
Download the latest desktop build from the [Octopal releases page](https://github.com/The-Syntax-Slayer/Octopal/releases/latest).
...
| Platform | Download |
|----------|----------|
| **Windows** | [Octopal-Desktop-2026.6.21-win-x64.exe](https://github.com/The-Syntax-Slayer/Octopal/releases/download/v2026.06.21/Octopal-Desktop-2026.6.21-win-x64.exe) |
| **macOS Apple Silicon** | [Octopal-Desktop-2026.6.21-mac-arm64.dmg](https://github.com/The-Syntax-Slayer/Octopal/releases/download/v2026.06.21/Octopal-Desktop-2026.6.21-mac-arm64.dmg) |
| **macOS Intel** | [Octopal-Desktop-2026.6.21-mac-x64.dmg](https://github.com/The-Syntax-Slayer/Octopal/releases/download/v2026.06.21/Octopal-Desktop-2026.6.21-mac-x64.dmg) |
| **Linux** | [Octopal-Desktop-2026.6.21-linux-x86_64.AppImage](https://github.com/The-Syntax-Slayer/Octopal/releases/download/v2026.06.21/Octopal-Desktop-2026.6.21-linux-x86_64.AppImage) |
...
```bash
curl -fsSL https://raw.githubusercontent.com/The-Syntax-Slayer/Octopal/main/scripts/octopal.sh | bash
```

Windows PowerShell:

```powershell
irm https://raw.githubusercontent.com/The-Syntax-Slayer/Octopal/main/scripts/octopal.ps1 | iex
```
...
```bash
git clone https://github.com/The-Syntax-Slayer/Octopal.git
cd Octopal
uv sync
uv run octopal configure
uv run octopal start
...
[![CI Build](https://github.com/The-Syntax-Slayer/Octopal/actions/workflows/ci.yml/badge.svg)](https://github.com/The-Syntax-Slayer/Octopal/actions)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/The-Syntax-Slayer/Octopal/pulls)
[![Maintained](https://img.shields.io/badge/Maintained%3F-yes-green.svg)](https://github.com/The-Syntax-Slayer/Octopal/graphs/commit-activity)
