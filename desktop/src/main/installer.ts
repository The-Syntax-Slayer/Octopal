...
const REPO_URL = "https://github.com/The-Syntax-Slayer/Octopal.git";
const LATEST_RELEASE_API_URL = "https://api.github.com/repos/The-Syntax-Slayer/Octopal/releases/latest";
